  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
        <img src="<?= base_url() ?>assets/img/Contact-us.png" class="img-fluid animated" alt="Contact-us">
      </div>
    </div>
  </div>
        ...
        <form id="contact_details" class="php-email-form needs-validation" novalidate>
          ...
          <div class="row">
            <div class="form-group col-md-12">
              ...
              <input type="text" name="phone_no" class="form-control numeric_only" id="PhoneNo" required placeholder="Enter Phone Number" minlength="10" aria-describedby="phone_noHelp" placeholder="Enter Phone" maxlength="10">
              <div class="invalid-feedback">
          ...
          <div class="text-center d-flex mt-3">
            <button type="submit" class="btn btn-primary" onclick="insertDetails(event)">Save</button>
          </div>
