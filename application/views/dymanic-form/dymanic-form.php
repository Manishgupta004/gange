      ...
      <div class="row extclss">
        <div class="col-md-6" data-aos="fade-left" data-aos-delay="100">
          <div class="feature-images" style="width: 80%;">
            <img src="<?= base_url() ?>assets/img/dynamic-form.png" style="width: 100%; height: auto;" alt="dynamic-form">
          </div>
        </div>
        ...
        <div class="col-md-6 d-flex justify-content-center align-items-center" style="font-size: larger;">
          <div class="feature-details aos-init" data-aos="fade-right" data-aos-delay="100">
            ...
            <ul class="features-point">
              <li> Add Dynamic fields in Lead, Sales Order, invoice</li>
            </ul>
            <p style="margin-top:20px;"> “ In VedaERP you can add dynamic fields in Invoice, sale order and lead.”</p>
          </div>
        </div>
      </div>
    </div>
